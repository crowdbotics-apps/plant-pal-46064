"""
Django settings for plant_pal_46064 project.
...
ROOT_URLCONF = 'plant_pal_46064.urls'
...
WSGI_APPLICATION = 'plant_pal_46064.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plant_pal_46064 API",
    "DESCRIPTION": "API documentation for plant_pal_46064 App",
    "VERSION": "v1",
}
